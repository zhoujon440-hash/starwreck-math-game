...
export const G01_SCN04: SceneDefinition = {
  ...
  states: {
    ...
    S4: { id: 'S4', title: '数据毛刺', objective: '从安全节点恢复并确认校准结果', narrative: '异常数据会退回星图台安全节点，正确碎片和证据全部保留。', safeCheckpoint: true },
    S5: { id: 'S5', title: '异常信号', objective: '仅分析已取得的异常证据', narrative: '十二个异常点同时浮现，其中最弱的信号反复删除自身。' },
