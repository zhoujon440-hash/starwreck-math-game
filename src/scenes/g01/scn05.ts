...
export const G01_SCN05: SceneDefinition = {
  ...
  states: {
    ...
    S1: { id: 'S1', title: '安全节点A', objective: '沿第一航段确认安全节点B', narrative: '第一航段已经确认。碰撞路线只撤销本次尝试，不抹除节点A。' },
    S2: { id: 'S2', title: '安全节点B', objective: '从左侧工具槽取得旁路板', narrative: '第二航段已经确认，第三段被锁在一扇短时窗口之后。', safeCheckpoint: true },
    S3: { id: 'S3', title: '旁路槽', objective: '把旁路板拖到中央航线旁路槽', narrative: '错误道具不会消耗；正确安装会打开极短的通行窗口。' },
    S4: { id: 'S4', title: '短时窗口', objective: '在窗口关闭前确认安全落点', narrative: '若窗口关闭，返回最近安全步骤并保留全部正确路线。' },
    S5: { id: 'S5', title: '安全落点', objective: '确认着陆航线并保存', narrative: '半条安全路线已经接成完整通路，七码正在锁定着陆点。', safeCheckpoint: true },
  ...
  hotspots: [
    ...
    { id: 'RUNTIME-HS-G01-05-COLLISION-NODE-A', kind: 'inspect', ariaLabel: '尝试节点A旁的碰撞路线', area: { x: 35, y: 49, width: 10, height: 16 }, activeStates: ['S0'], scope: 'scene' },
    { id: 'HS-G01-0022', kind: 'inspect', ariaLabel: '确认垃圾雨安全节点B', area: { x: 61, y: 28, width: 12, height: 17 }, activeStates: ['S1'], scope: 'scene' },
    { id: 'RUNTIME-HS-G01-05-COLLISION-NODE-B', kind: 'inspect', ariaLabel: '尝试节点B旁的碰撞路线', area: { x: 72, y: 42, width: 11, height: 17 }, activeStates: ['S1'], scope: 'scene' },
  ...
  transitions: [
    ...
    { from: 'S0', event: 'inspect:RUNTIME-HS-G01-05-COLLISION-NODE-A', to: 'S0' },
    { from: 'S1', event: 'inspect:HS-G01-0022', to: 'S2' },
    { from: 'S1', event: 'inspect:RUNTIME-HS-G01-05-COLLISION-NODE-B', to: 'S1' },
