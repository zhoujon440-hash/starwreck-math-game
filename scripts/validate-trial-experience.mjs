...
let sceneHud = read('src/game-scene/SceneHud.ts')
...
check(gameView.includes('performTrialMechanic') && sceneHud.includes('data-action="open-map"'), 'TRIAL-MECHANIC-004', 'mechanics or scene map are not wired into the runtime')
